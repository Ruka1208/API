        ...
        <div class="account_container">
            ...
            <div class="account_content row">
                ...
                <div class="account_create">
                    <button><a href="index.php?action=account_management&query=add">Create new user</a></button>
                </div>
            </div>
            <div class="account_show">
                <table id="users_table" border="1" width="100%" style="border-collapse: collapse ; text-align: center; margin-top:20px; border: 0.1px solid #f5f5f5">
                    ...
                    <tr>
                        ...
                        <td>
                            <button id="btn_1" class="btn_1"><a href="index.php?action=account_management&query=update&id=<?php echo $user['id_users']; ?>">Update</a></button>

                            <button name="delete_users" class="btn_2 delete-btn"><a href="index.php?action=account_management&query=delete&id=<?php echo $user['id_users']; ?>">Delete</a></button>
                        </td>
                    </tr>
                    <?php 
                        }
